    ...
    <>
      ...
      <section className="section-shell py-16">
        ...
        <div className="mt-8 grid gap-6 rounded-lg border border-[#F7EAD0] bg-white p-6 text-sm leading-7 text-[#5A2E0C]">
          ...
          <p>
            DigitalSeva provides information about nonprofit platform services, SEO, digital
            marketing, social media marketing, AI automation, and custom software for eligible
            organizations. Website content does not create a binding service agreement.
          </p>
          <p>
